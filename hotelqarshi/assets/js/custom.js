...
======================================*/
    ...
    function makeTimer() {
        ...
        $("#days").html(days + '<span class="camp">Kun</span>');
        $("#hours").html(hours + '<span class="camp">Soat</span>');
        $("#minutes").html(minutes + '<span class="camp">Daqiqa</span>');
        $("#seconds").html(seconds + '<span class="camp">Soniya</span>');
